...
public class T34 extends AbstractTank {
 // int maxSpeed = 10;
    ...
    private void loadImages(){
        InputStream is = battle.getClassLoader().getResourceAsStream("RedTank.png");
        try {
        ...
        is = battle.getClassLoader().getResourceAsStream("RedTankRight.png");
        try {
        ...
        is = battle.getClassLoader().getResourceAsStream("RedTankDown.png");
        try {
        ...
        is = battle.getClassLoader().getResourceAsStream("RedTankLeft.png");
        try {
